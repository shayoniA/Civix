...
const CommunityVotingPage = () => {
  ...
  >
    ...
    >
      <h1 style={{ fontWeight: 'bold', fontSize: '2.25rem', marginBottom: 4 }}>
        Community Voting Dashboard
      </h1>
      <p style={{ fontWeight: 'bold', fontSize: '1.25rem', marginBottom: 16 }}>
        Help prioritize local issues in your area
      </p>
    </motion.div>
